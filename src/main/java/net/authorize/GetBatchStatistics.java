 ...
 *         &lt;element name="request" type="{https://api.authorize.net/soap/v1/}GetBatchStatisticsRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetBatchStatistics {
    ...
    protected GetBatchStatisticsRequestType request;
     ...
     * @return
     *     possible object is
     *     {@link GetBatchStatisticsRequestType }
     *     
     */
    public GetBatchStatisticsRequestType getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetBatchStatisticsRequestType value) {
        this.request = value;
    }

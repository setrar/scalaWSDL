 ...
 *         &lt;element name="request" type="{https://api.authorize.net/soap/v1/}GetTransactionListRequestType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetTransactionList {
    ...
    protected GetTransactionListRequestType request;
     ...
     * @return
     *     possible object is
     *     {@link GetTransactionListRequestType }
     *     
     */
    public GetTransactionListRequestType getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetTransactionListRequestType value) {
        this.request = value;
    }

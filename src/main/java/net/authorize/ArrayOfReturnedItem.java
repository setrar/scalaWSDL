 ...
 *       &lt;sequence>
 *         &lt;element name="returnedItem" type="{https://api.authorize.net/soap/v1/}returnedItem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfReturnedItem {
    ...
    protected List<ReturnedItem> returnedItem;
     ...
     * 
     */
    public List<ReturnedItem> getReturnedItem() {
        if (returnedItem == null) {
            returnedItem = new ArrayList<ReturnedItem>();
        }
